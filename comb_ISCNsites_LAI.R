...
if(first==TRUE){
  ...
  write_csv(neon_hs_table,
            paste0(user_wd,"/NEON-AOP/data/hs_lai/temporary_ISCN_lai_table.csv")
  )
}
#final results:------
neon_hs_table <- read_csv(paste0(user_wd,"/NEON-AOP/data/hs_lai/temporary_ISCN_lai_table.csv"))
...
ggsave(file=paste0(user_wd,"/NEON-AOP/data/ISCN_lai_soc.png"),
