...
col_name <- paste0("wavelength_",colnames(wide_data)[3:361])
length(col_name) #359 wavelengths/bands
colnames(wide_data)[3:361] <- col_name
...
wide_data=wide_data[,1:361]

#2 include nlcdclass
wide_data=wide_data %>% select(-soilTypeOrder)

#3 only use numerical predictors
wide_data=wide_data %>% select(-soilTypeOrder,-nlcdClass)

#2 include nlcdclass,soiltypeorder
...
# 1. Save model
 file_name <- "explore_models/wavelength_only_model.RData" #  % Var explained: 49.92
 file_name <- "explore_models/numerical_predictors_model.RData" #% Var explained: 54.09
 file_name <- "explore_models/nlcd_class_model.RData" # % Var explained: 59.06
 file_name <- "explore_models/soiltype_nlcd_class_model.RData" # % Var explained: 55.56
...
#save pls model-----================================================================
# 1. Save model
file_name <- "explore_models/wavelength_only_model_pls.RData" #  R2 0.5132530
file_name <- "explore_models/numerical_predictors_model_pls.RData" # R2 0.5090451
file_name <- "explore_models/nlcd_class_model_pls.RData" # R2 0.5267717
file_name <- "explore_models/soiltype_nlcd_class_model_pls.RData" # 0.5155534
