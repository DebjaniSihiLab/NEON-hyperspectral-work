...
download_HS_with_buffer <- function(spc_mgp_sls_30cm_locationSOC,
                                           site="HARV",
...
byTileAOP(dpID = #"DP3.30006.001", # NEON-AOP product
            "DP1.30006.001", # NEON-AOP flight line data DP1
              site = site, # Site code
...
download_sites=allsites[6:47]
  
start <- Sys.time()
  for (Onesite in download_sites) {
    download_HS_with_buffer(
