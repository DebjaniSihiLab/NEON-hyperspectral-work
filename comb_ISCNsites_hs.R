...
if(first==TRUE){
  ...
  write_csv(neon_hs_table,
            paste0(user_wd,"/NEON-AOP/data/hs_lai/temporary_ISCN_hs_table.csv")
  )
}
#final results:------
neon_hs_table <- read_csv(paste0(user_wd,"/NEON-AOP/data/hs_lai/temporary_ISCN_hs_table.csv"))
...
ggsave(file=paste0(user_wd,"/NEON-AOP/data/ISCN_hs_soc.png"),
